                ...
                <div className="generalEnquiryContent">
                    <div className="generalEnquiryLeft">
                        ...
                        <div className="EnquiryField">
                            ...
                            <div className="yourNameField"><input list="enquiry" name="name" placeholder="--Select--" />
                                <datalist id="enquiry">
                        ...
                        <div className="MessageArea">
                            ...
                            <div className="messageField"><textarea name="message" placeholder="Type Here" /></div>
                        </div>
                        <div className="SubmitButtonArea">
                            <div className="SubmitButton"><Button variant="success">Submit</Button></div>
                            <div className="ThankyouText">Thank you. We'll get back to you shortly.</div>
                        </div>
                    </div>
                    <div className="generalEnquiryRight">
                        <div className="CompanyNameSmall">Aluflouride Ltd.</div>
                        <div className="CompanyAddressSmall">Mulagada,Mindi Vishakhapatam 530 012 Andhra Pradesh <br /> India</div>
