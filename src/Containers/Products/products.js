                ...
                <div className="specificationsSection">
                    <div className="specificationsTables">
                        ...
                        <div className="aluminumflourideTable">
                            <table>
                                <tr>
                                    <th colSpan={2} className="tableHeading">Aluminum Flouride</th>
                                </tr>
                                <tr>
                                    <td>Description</td>
                        ...
                        <div className="exploreNowButton"><Button variant="success">ENQUIRE NOW</Button> </div>
                        ...
                        <div className="productDatasheetButton"><Button variant="success">PRODUCT DATA SHEET</Button></div>
                    </div>

                    
                    <div><img className="specificationsImg" src={AluminiumFluorideImage}></img></div>
                </div>
            </div>
            <Footer />
        </>
