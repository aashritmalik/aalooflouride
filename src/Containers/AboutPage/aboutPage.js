    ...
    return (
        ...
        <>
            ...
            <div className="aboutPageIntrobox">
                ...
                <div className="introBoxPara">
                    Alufluoride Limited started the project in 1993 for producing Aluminium Fluoride and related products. The project was completed in record time at a cost of Rs.200 million. Trial runs commenced in Nov, 1994 and a quality product was produced during December, 1994. Supplies started immediately thereafter to primary Aluminium smelters. The Company increased the production year after year maintaining high quality standards.</div>
            </div>

            <div class="gridContainer">
                <button type="button" id="milestones" class="btn" onClick={() => setTab('milestones')}>Milestones</button>
                <button type="button" id="team" class="btn" onClick={() => setTab('team')}>Team</button>
                <button type="button" id="customers" class="btn" onClick={() => setTab('customers')}>Customers</button>
                <button type="button" id="quality" class="btn" onClick={() => setTab('quality')}>Quality</button>
                <button type="button" id="environment" class="btn" onClick={() => setTab('environment')}>Environment</button>
                <button type="button" id="CSR" class="btn" onClick={() => setTab('csr')}>CSR</button>
            </div>
