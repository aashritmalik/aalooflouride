        ...
        <>
            ...
            <div className="investorRelationsArea">
                <div class="gridContainer2">
                    <button type="button" id="quarterlyReports" class="btn" onClick={() => setTab('quarterlyReports')}>Quarterly Reports</button>
                    <button type="button" id="annualReports" class="btn" onClick={() => setTab('annualReports')}>Annual Reports</button>
                    <button type="button" id="corporateGovernance" class="btn" onClick={() => setTab('corporateGovernance')}>Corporate Governance</button>
                    <button type="button" id="boardMeeting" class="btn" onClick={() => setTab('boardMeeting')}>Board Meeting Intimation</button>
                    <button type="button" id="shareHoldingPattern" class="btn" onClick={() => setTab('shareHoldingPattern')}>Shareholding Pattern</button>
                    <button type="button" id="others" class="btn" onClick={() => setTab('others')}>Others</button>
                </div>
